...
export default function Reward() {
  ...
  return (
    <div className="col-lg-6 col-12 reward ps-lg-4">
      ...
      <div className="content mt-3 px-lg-0 px-3 ps-lg-3">
      ...
      <div className="px-lg-0 px-3 ps-lg-3">
        ...
        {(totalValue >= maxValues.Bronze || rewardProValue >= 30000) && (
          <img src={bronze} className="rewardImg d-md-inline d-block mb-md-0 mb-4" alt="bronze" />
        )}

        {/* Silver Reward */}
        {(totalValue >= maxValues.Silver || rewardProValue >= 60000) && (
          <img src={silver} className="rewardImg d-md-inline d-block mb-md-0 mb-4" alt="silver" />
        )}

        {/* Gold Reward */}
        {(totalValue >= maxValues.Gold || rewardProValue >= 90000) &&(
          <img src={gold} className="rewardImg d-md-inline d-block mb-md-0 mb-4" alt="gold" />
        )}
      </div>
    </div>
  );
